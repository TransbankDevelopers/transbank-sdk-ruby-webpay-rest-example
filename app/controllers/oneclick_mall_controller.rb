class OneclickMallController < ApplicationController
  ...
  def finish_inscription
    @req = params.as_json
    @token = @req["TBK_TOKEN"]
    @child_commerce_codes = ::Transbank::Common::IntegrationCommerceCodes::ONECLICK_MALL_CHILD_COMMERCE_CODES
  ...
  def new_transaction
    ...
    @transaction = Transbank::Webpay::Oneclick::MallTransaction.new
  end
