class OneclickMallDeferredController < ApplicationController
  ...
  def capture
    @response = Transbank::Webpay::Oneclick::MallDeferredTransaction::capture(
      params[:commerce_code], params[:buy_order], params[:capture_amount], params[:authorization_code]
    )
  end
  ...
  def refund
    ...
    @resp = Transbank::Webpay::Oneclick::MallDeferredTransaction::refund(buy_order: @buy_order,
