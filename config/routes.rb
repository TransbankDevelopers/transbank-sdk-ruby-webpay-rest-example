Rails.application.routes.draw do
  ...
  get '/webpayplus/mall/status', to: 'webpay#mall_status'
  ...
  get '/oneclick/mall/inscription/start', to: 'oneclick_mall#start_inscription'
  ...
  get '/oneclick/inscription/finish', to: 'oneclick_mall#finish_inscription'
  get '/oneclick/mall/authorize', to: 'oneclick_mall#authorize'
  get '/oneclick/mall/status', to: 'oneclick_mall#status'
  ...
  get '/oneclick/mall_deferred/inscription/finish', to: 'oneclick_mall_deferred#finish_inscription'
